...
/**
 * CatEcoProjAtivDel form base class.
 *
 * @method CatEcoProjAtivDel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseCatEcoProjAtivDelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                    => new sfValidatorPropelChoice(array('model' => 'CatEcoProjAtivDel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('cat_eco_proj_ativ_del[%s]');
