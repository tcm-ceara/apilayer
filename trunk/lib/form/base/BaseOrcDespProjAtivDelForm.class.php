...
/**
 * OrcDespProjAtivDel form base class.
 *
 * @method OrcDespProjAtivDel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOrcDespProjAtivDelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'nm_proj_ativ'         => new sfValidatorString(array('max_length' => 120)),
      'de_proj_ativ'         => new sfValidatorString(array('max_length' => 255)),
      'vl_tot_fix_proj_ativ' => new sfValidatorNumber(),
      'id'                   => new sfValidatorPropelChoice(array('model' => 'OrcDespProjAtivDel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('orc_desp_proj_ativ_del[%s]');
