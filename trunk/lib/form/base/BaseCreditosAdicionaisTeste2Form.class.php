...
/**
 * CreditosAdicionaisTeste2 form base class.
 *
 * @method CreditosAdicionaisTeste2 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseCreditosAdicionaisTeste2Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'cd_municipio'           => new sfValidatorPropelChoice(array('model' => 'CreditosAdicionaisTeste2', 'column' => 'cd_municipio', 'required' => false)),
      'dt_versao_orc'          => new sfValidatorPropelChoice(array('model' => 'CreditosAdicionaisTeste2', 'column' => 'dt_versao_orc', 'required' => false)),
      'dt_abert_cred_ca'       => new sfValidatorPropelChoice(array('model' => 'CreditosAdicionaisTeste2', 'column' => 'dt_abert_cred_ca', 'required' => false)),
      'nu_seq_no_dia_ca'       => new sfValidatorPropelChoice(array('model' => 'CreditosAdicionaisTeste2', 'column' => 'nu_seq_no_dia_ca', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('creditos_adicionais_teste2[%s]');
  ...
  {
    return 'CreditosAdicionaisTeste2';
  }
