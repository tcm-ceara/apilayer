...
/**
 * TiposEstrutura form base class.
 *
 * @method TiposEstrutura getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseTiposEstruturaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'TiposEstrutura', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('tipos_estrutura[%s]');
