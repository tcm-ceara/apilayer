...
/**
 * DocOcorredel form base class.
 *
 * @method DocOcorredel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseDocOcorredelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'             => new sfValidatorPropelChoice(array('model' => 'DocOcorredel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('doc_ocorredel[%s]');
