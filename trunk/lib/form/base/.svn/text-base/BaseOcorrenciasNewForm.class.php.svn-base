...
/**
 * OcorrenciasNew form base class.
 *
 * @method OcorrenciasNew getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOcorrenciasNewForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'OcorrenciasNew', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('ocorrencias_new[%s]');
