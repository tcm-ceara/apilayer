...
/**
 * Erros form base class.
 *
 * @method Erros getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseErrosForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'             => new sfValidatorPropelChoice(array('model' => 'Erros', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('erros[%s]');
