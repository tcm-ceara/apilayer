...
/**
 * AgentesPublicosDel form base class.
 *
 * @method AgentesPublicosDel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseAgentesPublicosDelForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'cd_rpgrama_social_ap'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'cd_rpgrama_social_ap'  => new sfValidatorString(array('max_length' => 11, 'required' => false)),
      'id'                    => new sfValidatorPropelChoice(array('model' => 'AgentesPublicosDel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('agentes_publicos_del[%s]');
