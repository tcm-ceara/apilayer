...
/**
 * OrcDespCatEcoTcm15092009 form base class.
 *
 * @method OrcDespCatEcoTcm15092009 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOrcDespCatEcoTcm15092009Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'OrcDespCatEcoTcm15092009', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('orc_desp_cat_eco_tcm15092009[%s]');
  ...
  {
    return 'OrcDespCatEcoTcm15092009';
  }
