...
/**
 * Ocorrenciadel form base class.
 *
 * @method Ocorrenciadel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOcorrenciadelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'Ocorrenciadel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('ocorrenciadel[%s]');
