...
/**
 * UnidOrcUgDel form base class.
 *
 * @method UnidOrcUgDel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseUnidOrcUgDelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'              => new sfValidatorPropelChoice(array('model' => 'UnidOrcUgDel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('unid_orc_ug_del[%s]');
