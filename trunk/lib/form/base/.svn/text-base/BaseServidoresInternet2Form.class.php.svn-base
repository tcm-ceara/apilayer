...
/**
 * ServidoresInternet2 form base class.
 *
 * @method ServidoresInternet2 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseServidoresInternet2Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                 => new sfValidatorPropelChoice(array('model' => 'ServidoresInternet2', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('servidores_internet2[%s]');
