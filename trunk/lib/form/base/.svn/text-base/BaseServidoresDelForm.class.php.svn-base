...
/**
 * ServidoresDel form base class.
 *
 * @method ServidoresDel getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseServidoresDelForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                 => new sfValidatorPropelChoice(array('model' => 'ServidoresDel', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('servidores_del[%s]');
