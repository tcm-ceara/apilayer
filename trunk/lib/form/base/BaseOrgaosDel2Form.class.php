...
/**
 * OrgaosDel2 form base class.
 *
 * @method OrgaosDel2 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOrgaosDel2Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'OrgaosDel2', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('orgaos_del2[%s]');
