...
/**
 * NotasFiscaisLiquidTemp form base class.
 *
 * @method NotasFiscaisLiquidTemp getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseNotasFiscaisLiquidTempForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                     => new sfValidatorPropelChoice(array('model' => 'NotasFiscaisLiquidTemp', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('notas_fiscais_liquid_temp[%s]');
