...
/**
 * CnpjmuniAtual form base class.
 *
 * @method CnpjmuniAtual getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseCnpjmuniAtualForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'               => new sfValidatorPropelChoice(array('model' => 'CnpjmuniAtual', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('cnpjmuni_atual[%s]');
