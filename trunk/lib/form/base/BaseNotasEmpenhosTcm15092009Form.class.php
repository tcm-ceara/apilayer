...
/**
 * NotasEmpenhosTcm15092009 form base class.
 *
 * @method NotasEmpenhosTcm15092009 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseNotasEmpenhosTcm15092009Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                    => new sfValidatorPropelChoice(array('model' => 'NotasEmpenhosTcm15092009', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('notas_empenhos_tcm15092009[%s]');
  ...
  {
    return 'NotasEmpenhosTcm15092009';
  }
