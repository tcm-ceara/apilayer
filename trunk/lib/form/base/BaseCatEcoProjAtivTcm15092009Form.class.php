...
/**
 * CatEcoProjAtivTcm15092009 form base class.
 *
 * @method CatEcoProjAtivTcm15092009 getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseCatEcoProjAtivTcm15092009Form extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id'                    => new sfValidatorPropelChoice(array('model' => 'CatEcoProjAtivTcm15092009', 'column' => 'id', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('cat_eco_proj_ativ_tcm15092009[%s]');
  ...
  {
    return 'CatEcoProjAtivTcm15092009';
  }
