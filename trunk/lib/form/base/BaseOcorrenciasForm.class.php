...
/**
 * Ocorrencias form base class.
 *
 * @method Ocorrencias getObject() Returns the current form's model object
 *
 * @package    sim
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOcorrenciasForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'nu_ano_ocorre'    => new sfValidatorPropelChoice(array('model' => 'Ocorrencias', 'column' => 'nu_ano_ocorre', 'required' => false)),
      'nu_cont_ocorre'   => new sfValidatorPropelChoice(array('model' => 'Ocorrencias', 'column' => 'nu_cont_ocorre', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ocorrencias[%s]');
